export default function Termometro({ temperatura = 25 }) {
  ...
  return (
    <div className="bg-gray-900 rounded-lg p-6 shadow-xl flex flex-col items-center w-full border border-gray-700">
      <h2 className="text-white text-xl font-bold mb-4 tracking-wider">TEMPERATURA</h2>
      <svg width="220" height="220" viewBox="0 0 200 200" className="overflow-visible">
        ...
        <path d="M 43.4 156.6 A 80 80 0 1 1 156.6 156.6" fill="none" stroke="url(#gradTemp)" strokeWidth="12" strokeLinecap="round" />
      ...
      <div className="mt-2 text-center">
        <div className="text-white text-4xl font-bold font-mono">{t.toFixed(1)}</div>
        <div className="text-gray-400 text-sm font-medium">°C</div>
      </div>
    </div>
  );
}